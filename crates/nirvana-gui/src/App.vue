...
const appInfo = ref<AppInfo>({ name: "nirvana", version: "0.1.1-pre-alpha" });
...
const getAppInfo = async () => {
    try {
        ...
        appInfo.value = {
            ...
            version: response.version || "0.1.1-pre-alpha",
        };
    } catch {
        appInfo.value = { name: "nirvana", version: "0.1.1-pre-alpha" };
    }
};
